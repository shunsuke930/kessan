  ...
  return (
    <>
      <button
        ...
        className="absolute right-3 bottom-16 z-30 flex h-9 w-9 items-center justify-center rounded-full bg-black/60 text-base text-white shadow-lg backdrop-blur"
      >
        🐛
      </button>

      {open && (
        <div className="absolute inset-x-2 bottom-28 z-30 rounded-xl border border-amber-500/40 bg-slate-950/95 p-3 text-slate-100 shadow-xl backdrop-blur">
